...
const SecoundProfileRight: React.FC<ProfileLeftProps> = ({
  title,
  orderId,
  activationTime,
  dlcLabel,
  ...
  return (
    <>
      <div className="mobile-second-profile__left only_mobile">
        <img width={93} height={93} src={questionImg} alt="Question Img" />

        <div className="second-profile__left__row">
          {/* DLC badge */}
          <div className="profile__left__row__info">
            <span className="profile__left__row__info__text">{dlcLabel}</span>
            <svg
              width="16"
              height="16"
              viewBox="0 0 16 16"
          ...
          <div className="profile__left__row__info">
            <span className="profile__left__row__info__text">
              {t("profileLeft.activationTimeLabel", { time: activationTime })}
            </span>
            <svg
              width="16"
              height="16"
        ...
        <h2 className="second-profile__left__title">{title}</h2>

        <p className="second-profile__left__row__text">
          {t("profileLeft.orderLabel", { id: orderId })}
        </p>
      ...
      <div className="secound-profile__right">
        ...
        <div className="desctop-second-profile__left">
          <img width={150} height={150} src={questionImg} alt="Question Img" />
