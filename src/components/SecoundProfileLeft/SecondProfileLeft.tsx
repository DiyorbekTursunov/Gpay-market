...
const SecondProfileLeft: React.FC<SecondProfileLeftProps> = ({ imgSrc, gameSession }) => {
  ...
  return (
    <div className="second-profile__left">
      <img src={imgSrc || "/placeholder.svg"} alt={gameSession.itemName || ""} className="second-profile__left__img" />
        ...
        <div className="second-profile__left__row__info">
          <span className="second-profile__left__row__info__text">
            {t("profileLeft.activationTimeLabel", {
              time: formatDateTime(gameSession.addedDateTime),
            })}
          </span>
          <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
      ...
      <p className="second-profile__left__bottom__text mobile_hidden">{t("profilePage.headerText")}</p>
    </div>
  )
}
